...
impl fmt::Display for MinhaErro {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match self {
            MinhaErro::DivisaoPorZero => write!(f, "Não pode dividir por zero"),
            MinhaErro::NumeroNegativo => write!(f, "Número negativo não permitido"),
        }
    }
}

// Função usando o erro personalizado
fn dividir(a: i32, b: i32) -> Result<i32, MinhaErro> {
    if b == 0 {
        Err(MinhaErro::DivisaoPorZero)
    } else if a < 0 || b < 0 {
        Err(MinhaErro::NumeroNegativo)
    } else {
        Ok(a / b)
    }
}
...
> **Ha mais possibilidades em tratamento de erros, como:**
